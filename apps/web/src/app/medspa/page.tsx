        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '16px', lineHeight: 1.6, marginBottom: '24px' }}>
              We price based on your clinic&apos;s call volume and specialization. Most MedSpa clients run a 30-Day Reactivation Sprint first, then move to a monthly retainer.
            </p>
          ...
          <div style={{ textAlign: 'right' }}>
            <a
              href="https://calendly.com/vervemindai/lead?utm_source=vervemindai.com&utm_medium=website&utm_campaign=medspa&utm_content=pricing_section"
              target="_blank"
              rel="noopener noreferrer"
              style={{
